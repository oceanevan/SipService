...
package com.htc.vzwsipservice.incallui;

import com.android.contacts.common.CallUtil;
import com.android.contacts.common.testing.NeededForTesting;
import com.htc.vzwsipservice.Log;
import com.htc.vzwsipservice.VzwSipApplication;
...
//            mTelecommCall.getVideoCall().registerCallback(mVideoCallCallback);
        ...
        if (!Objects.equals(mPhoneAccountHandle, newPhoneAccountHandle)) {
            ...
            if (mPhoneAccountHandle != null) {
                TelecomManager mgr = VzwSipApplication.getInstance().getTelecomManager();
